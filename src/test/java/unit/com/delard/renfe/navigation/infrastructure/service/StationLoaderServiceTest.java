...
class StationLoaderServiceTest
{
    ...
    private static final String SAMPLE_JS_CONTENT =
            "var estacionesEstatico=[{\"cdgoEstacion\":\"MADRI\",\"desgEstacion\":\"MADRID (TODAS)\",\"clave\":\"MAD\"},{\"cdgoEstacion\":\"BARC\",\"desgEstacion\":\"BARCELONA\",\"clave\":\"BAR\"}]";
    ...
    void testCompareWithLocalFileWithDifferentStations() throws Exception
    {
        ...
        List<Map<String, Object>> urlStations = List.of(
                Map.of("cdgoEstacion", "DIFFERENT", "desgEstacion", "DIFFERENT STATION", "clave",
                        "0071,DIFFERENT,null"));
    ...
    void testParseJavaScriptStationsWithNestedArrays() throws Exception
    {
        ...
        String jsContent =
                "var estacionesEstatico=[{\"cdgoEstacion\":\"MADRI\",\"nested\":[1,2,3]},{\"cdgoEstacion\":\"BARC\"}]";
    ...
    void testParseJavaScriptStationsWithComplexContent() throws Exception
    {
        ...
        String jsContent =
                "var otherVar=123; var estacionesEstatico=[{\"cdgoEstacion\":\"MADRI\"}]; var anotherVar=456;";
